# Automation: Vendor Balance Monitor (PowerShell)

Write-Host "Initializing Vendor Monitor..." -ForegroundColor Cyan
Write-Host "=================================================" -ForegroundColor Cyan

# 1. API Endpoint
Write-Host "1. Creating API: src/app/api/cron/monitor-vendor/route.ts" -ForegroundColor Yellow
$dirApi = "src\app\api\cron\monitor-vendor"
...
'@
$routeContent | Set-Content -Path "src\app\api\cron\monitor-vendor\route.ts" -Encoding UTF8
Write-Host "   [?] API created." -ForegroundColor Green

Write-Host ""
Write-Host "=================================================" -ForegroundColor Cyan
Write-Host "Vendor Monitor Ready!" -ForegroundColor Green
Write-Host "Endpoint: GET /api/cron/monitor-vendor" -ForegroundColor White
Write-Host "Note: Uses 'system_settings' table." -ForegroundColor White
