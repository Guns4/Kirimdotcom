...
# Setup Voice Command Navigator
echo "🚀 Setting up Voice Navigation..."

# 1. Install Dependencies
echo "📦 Installing react-speech-recognition..."
npm install react-speech-recognition --legacy-peer-deps 
# Use legacy peer deps as it might have issues with React 19/Next 15 strictness, 
# but mostly works. Or use native API wrapper.

# 2. Create Voice Overlay Component
echo "🎤 Creating Voice Overlay..."
mkdir -p src/components/voice
cat << 'EOF' > src/components/voice/VoiceCommander.tsx
'use client'
