# Recurring Revenue: Automated Billing System (PowerShell)

Write-Host "Initializing Recurring Billing System..." -ForegroundColor Cyan
Write-Host "=================================================" -ForegroundColor Cyan

# 1. Cron API Route
Write-Host "1. Creating API Route: src\app\api\cron\billing\route.ts" -ForegroundColor Yellow
$dirApi = "src\app\api\cron\billing"
...
'@
$apiContent | Set-Content -Path "src\app\api\cron\billing\route.ts" -Encoding UTF8
Write-Host "   [?] API route created." -ForegroundColor Green

Write-Host ""
Write-Host "=================================================" -ForegroundColor Cyan
Write-Host "Recurring Billing System Ready!" -ForegroundColor Green
Write-Host "1. Endpoint: /api/cron/billing" -ForegroundColor White
Write-Host "2. Setup Cron Job (e.g. Vercel Cron) to hit this URL daily." -ForegroundColor White
Write-Host "3. Header Required: 'Authorization: Bearer <CRON_SECRET>'" -ForegroundColor Yellow
