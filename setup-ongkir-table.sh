...
# =============================================================================
# Upgrade Cost Comparison (TanStack Table & Sorting)
# =============================================================================
...
echo "2. Creating Component: components/logistics/OngkirTable.tsx"
mkdir -p components/logistics

cat <<EOF > components/logistics/OngkirTable.tsx
'use client';
...
EOF
echo "   ✓ OngkirTable component created."
echo ""
...
echo "2. Import OngkirTable in your page/component"
echo "3. Pass data array to the table component"
echo ""
echo "Example Usage:"
echo "  import { OngkirTable } from '@/components/logistics/OngkirTable';"
echo "  <OngkirTable data={ongkirData} />"
