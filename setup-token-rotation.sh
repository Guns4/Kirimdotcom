...
# -----------------------
# Guide & Config for Supabase Auth Token Rotation (RTR)

echo "🔐 Setting up Identity Security (RTR)..."

# 1. Output Instructions (Since this is Dashboard Config)
...
echo "👉 Please follow the steps in the MD file to configure Dashboard."
