...
# setup-emulator-block.sh
# -----------------------
# Prevents app execution on Emulators/Virtual Devices
# Uses @capacitor/device to detect environment

echo "🚫 Setting up Emulator Blocking System..."

# 1. Install Dependencies
echo "📦 Installing @capacitor/device..."
npm install @capacitor/device

# 2. Create Security Component
echo "🛡️  Creating EmulatorGuard Component..."
mkdir -p src/components/security

cat > src/components/security/EmulatorGuard.tsx << 'EOF'
'use client';
...
echo "✅ Emulator Guard Setup Complete!"
echo "👉 Wrap your root layout content with <EmulatorGuard>...</EmulatorGuard>"
