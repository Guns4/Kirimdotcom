# Passive Growth: Referral Automation (PowerShell)

Write-Host "Initializing Referral System..." -ForegroundColor Cyan
Write-Host "=================================================" -ForegroundColor Cyan

# 1. SQL Schema & Triggers
Write-Host "1. Generating SQL: referral_automation.sql" -ForegroundColor Yellow
$sqlContent = @'
...
'@
$sqlContent | Set-Content -Path "referral_automation.sql" -Encoding UTF8
Write-Host "   [?] SQL logic generated." -ForegroundColor Green

# 2. Server Action (Registration Helper)
Write-Host "2. Creating Action: src\app\actions\referral.ts" -ForegroundColor Yellow
...
'@
$actionContent | Set-Content -Path "src\app\actions\referral.ts" -Encoding UTF8
Write-Host "   [?] Server Action created." -ForegroundColor Green

Write-Host ""
Write-Host "=================================================" -ForegroundColor Cyan
Write-Host "Referral System Ready!" -ForegroundColor Green
Write-Host "1. Run 'referral_automation.sql'." -ForegroundColor White
Write-Host "2. Frontend: Call 'captureReferral' when user lands with ?ref=..." -ForegroundColor White
Write-Host "3. Backend: Call 'createReferralProfile' & 'assignReferrer' on SignUp." -ForegroundColor White
