...
# setup-canary-tokens.sh
# ----------------------
# Intrusion Detection System
# Generates "Honeytokens" (Traps) to catch hackers.

echo "🐦 Setting up Canary Tokens..."

# 1. Install Generator Script
mkdir -p src/scripts/security

# We write the generator logic to a TS file for better handling
cat > src/scripts/security/canary-generator.ts << 'EOF'
import fs from 'fs';
...
echo "✅ Canary Generator created at src/scripts/security/canary-generator.ts"
echo "👉 Run 'npx tsx src/scripts/security/canary-generator.ts' to plant traps."
