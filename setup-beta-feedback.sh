...
# setup-beta-feedback.sh
# ----------------------
# Shake-to-Report Logic for Beta Testers
# Features: Shake Detection, Screenshot, Log Capture, Support Ticket Submission
# Toggles: Active only in NEXT_PUBLIC_ENV=beta or development

echo "🐞 Setting up Beta Feedback System..."

# 1. Install Dependencies
echo "📦 Installing Capacitor Motion & Utilities..."
npm install @capacitor/motion html2canvas

# 2. Create Feedback Component
echo "🧩 Creating ShakeFeedback Component..."
mkdir -p src/components/qa

cat > src/components/qa/ShakeFeedback.tsx << 'EOF'
'use client';
...
# 3. Inject Component into Root Layout (Helper)
echo "📝 Remember to add <ShakeFeedback /> to your src/app/layout.tsx!"

echo "✅ Beta Feedback Setup Complete!"
