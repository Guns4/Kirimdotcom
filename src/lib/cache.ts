...
>(fn: T, tags: string[], revalidate: number = CACHE_DURATION.LONG) {
...
export function invalidateSettingsCache() {
  invalidateCaches([CACHE_TAGS.SITE_SETTINGS, CACHE_TAGS.COURIER_MARKUP]);
}
...
export function invalidateContentCache() {
  invalidateCaches([CACHE_TAGS.FAQ, CACHE_TAGS.BLOG, CACHE_TAGS.CATEGORIES]);
}
