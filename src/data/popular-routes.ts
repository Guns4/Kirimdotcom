...
export const popularRoutes: PopularRoute[] = [
    ...
    { origin: 'Jakarta Selatan', originId: '154', originSlug: 'jakarta-selatan', destination: 'Malang', destinationId: '180', destinationSlug: 'malang' },
    ...
    { origin: 'Malang', originId: '180', originSlug: 'malang', destination: 'Jakarta Selatan', destinationId: '154', destinationSlug: 'jakarta-selatan' },
]
