...
const MOCK_ITEMS = [
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1558317374-a3594743e527?w=800&q=80',
    stock: 5,
    sold: 2,
  },
  {
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8 text-center max-w-2xl mx-auto">
          ...
          <p className="text-zinc-500 dark:text-zinc-400">
            Kesempatan langka hanya untuk pengguna aplikasi setia kami. Download
            aplikasi sekarang untuk klaim harga gila ini.
          </p>
        </div>

        {/* Filter / Tags (Optional Visual) */}
        <div className="flex gap-2 overflow-x-auto pb-6 justify-center">
          {['Semua', 'Elektronik', 'Fashion', 'Gadget', 'Rumah Tangga'].map(
            (tag, i) => (
              <button
                key={tag}
        ...
        <div className="mt-12 p-8 bg-zinc-900 dark:bg-zinc-800 rounded-2xl relative overflow-hidden text-center">
          <div className="relative z-10">
            ...
            <p className="text-zinc-300 mb-6 max-w-xl mx-auto">
              Jangan lewatkan Flash Sale berikutnya. Install aplikasi CekKirim
              sekarang dan nyalakan notifikasi!
            </p>
            <a
