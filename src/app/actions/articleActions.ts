 ...
 */
export async function publishArticle(id: number): Promise<{ success: boolean; error?: string }> {
    try {
        const supabase = await createClient();
...
export async function updateArticle(
    id: number,
    updates: Partial<Pick<Article, 'title' | 'content_md' | 'meta_desc' | 'keywords' | 'status'>>
