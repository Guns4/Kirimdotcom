...
export const askBusinessConsultant = async (question: string) => {
  return safeAction(
    async (inputQuestion: string, user: any) => {
      ...
      if (lowerQ.includes('return') || lowerQ.includes('retur')) {
        ...
        answer =
          "Berdasarkan data bulan ini, produk dengan tingkat retur tertinggi adalah 'Baju Koko Modern' (5 Retur).";
        ...
        answer =
          'Profit bersih Anda bulan ini diperkirakan mencapai Rp 15.450.000, naik 12% dari bulan lalu.';
        ...
        answer =
          'Kurir tercepat minggu ini adalah J&T Express (Rata-rata 1.8 hari sampai).';
      } else {
        answer =
          "Saya dapat membantu menganalisa performa toko, retur, dan keuntungan Anda. Coba tanya: 'Produk apa yang paling banyak retur?'";
      }
