...
export async function checkSystemHealth() {
    const checks = [
        { type: 'website', url: process.env.NEXT_PUBLIC_APP_URL || 'https://cekkirim.com', name: 'Main Website' },
        { type: 'api', url: `${process.env.NEXT_PUBLIC_APP_URL}/api/health`, name: 'API Health' },
    ];
