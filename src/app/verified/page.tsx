...
export const metadata = {
    ...
    description: 'Verifikasi akun Anda dengan KYC untuk mendapatkan badge centang biru dan privilese khusus.',
};
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Verifikasi identitas Anda untuk meningkatkan kepercayaan dan kredibilitas
                    </p>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-bold text-gray-900">KTP / Identitas Resmi</h3>
                                <p className="text-sm text-gray-600">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-bold text-gray-900">Foto Selfie dengan KTP</h3>
                                <p className="text-sm text-gray-600">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-bold text-gray-900">Informasi Bisnis (Opsional)</h3>
                                <p className="text-sm text-gray-600">
                ...
                <div className="bg-yellow-50 border-2 border-yellow-300 rounded-xl p-6 mb-8">
                    <h3 className="font-bold text-yellow-900 mb-2">🔒 Privasi & Keamanan</h3>
