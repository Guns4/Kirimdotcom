                ...
                <div className="glass-card p-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-400">Gunakan API Key RajaOngkir pribadi Anda</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-yellow-500/10 border border-yellow-500/20 p-4 rounded-xl flex gap-3 text-sm text-yellow-200">
                            ...
                            <p>
                                API Key Anda disimpan <strong>hanya di browser (LocalStorage)</strong> dan tidak pernah disimpan di database kami. Key hanya dikirim saat Anda melakukan cek ongkir.
                            </p>
                        </div>
