...
export const metadata: Metadata = {
  ...
  description:
    'Diskusi seputar pengalaman pengiriman paket, review ekspedisi (JNE, J&T, SiCepat), dan tips logistik.',
};
      ...
      <div className="container-custom max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400">
            Ceritakan pengalamanmu kirim paket, komplain keterlambatan, atau
            bagi tips seputar ekspedisi di sini.
          </p>
        </div>
        ...
        <div className="glass-card p-6 md:p-8">
          ...
          <div className="bg-yellow-500/5 border border-yellow-500/10 p-4 rounded-xl mb-8 text-sm text-yellow-200 flex gap-3">
            ...
            <p>
              Gunakan bahasa yang sopan. Ujaran kebencian atau spam akan
              dihapus. Komentar di bawah menggunakan akun GitHub untuk mencegah
              spam.
            </p>
          </div>
          ...
          <div className="min-h-[400px]">
            ...
            <p className="text-center text-xs text-gray-600 mt-4">
              *Jika kolom komentar tidak muncul, pastikan konfigurasi Repository
              ID di kodingan sudah benar.
            </p>
          </div>
        </div>
      </div>
