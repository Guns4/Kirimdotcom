  ...
  const blogPosts = [
    {
      ...
      excerpt:
        'Panduan lengkap tracking paket dari berbagai kurir menggunakan CekKirim. Cepat, akurat, dan gratis!',
      category: 'Tutorial',
      date: '30 Des 2024',
    ...
    },
    {
      ...
      excerpt:
        'Strategi jitu menghemat biaya pengiriman hingga 40% untuk bisnis online Anda.',
    ...
    },
    {
      ...
      excerpt:
        'Analisis mendalam JNE, J&T, SiCepat, dan AnterAja. Mana yang paling cocok untuk bisnis Anda?',
      category: 'Review',
      date: '25 Des 2024',
    ...
    },
    {
      ...
      excerpt:
        'Pernah bingung dengan status tracking paket? Ini penjelasan lengkap setiap status pengiriman.',
      category: 'Edukasi',
      date: '22 Des 2024',
    ...
    },
    {
      ...
      excerpt:
        'Panduan praktis untuk seller agar terhindar dari pembeli COD nakal dan meminimalkan retur.',
      category: 'Tips Bisnis',
      date: '20 Des 2024',
    ...
    },
    {
      ...
      excerpt:
        'Ringkasan perubahan tarif dari berbagai ekspedisi di awal tahun 2024.',
      category: 'News',
      date: '18 Des 2024',
        ...
        <div className="container-custom">
          <div className="max-w-3xl">
            ...
            <p className="text-xl opacity-90">
              Tips, tutorial, dan insights seputar logistik & bisnis online
              Indonesia
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-50 to-purple-50">
        <div className="container-custom max-w-2xl text-center">
          ...
          <p className="text-gray-600 mb-8">
            Subscribe newsletter kami untuk tips bisnis online dan update fitur
            CekKirim
          </p>
