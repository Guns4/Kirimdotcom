...
import {
  createWARotator,
  getUserRotators,
} from '@/app/actions/waRotatorActions';
...
export const metadata = {
  ...
  description:
    'Bagikan 1 link, otomatis diarahkan ke beberapa CS WhatsApp secara bergantian',
};
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Tool <span className="font-bold text-green-600">GRATIS</span> untuk
            membagi chat WhatsApp ke beberapa CS secara otomatis!
          </p>
        </div>
