...
export const metadata = {
    ...
    description: 'Generator caption jualan otomatis untuk Instagram, WhatsApp, TikTok',
};
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Bingung mau nulis caption jualan? Tinggal pilih template, copy, dan share!
                        50+ caption siap pakai untuk semua kategori produk.
                    </p>
                </div>
                ...
                <div className="mt-12 bg-blue-50 rounded-xl border border-blue-200 p-6">
                    ...
                    <ul className="space-y-2 text-blue-800">
                        <li className="flex items-start gap-2">
                            ...
                            <span>Sesuaikan bagian yang ada [TANDA_KURUNG] dengan info produk Anda</span>
                        </li>
                        <li className="flex items-start gap-2">
                        ...
                        <li className="flex items-start gap-2">
                            ...
                            <span>A/B testing: Coba berbagai caption dan lihat mana yang paling efektif</span>
                        </li>
                        <li className="flex items-start gap-2">
                ...
                <div className="mt-12 text-center">
                    <div className="bg-white rounded-2xl shadow-xl p-8">
                        ...
                        <p className="text-gray-600 mb-6">
                            Langsung copy dan bagikan ke social media Anda!<br />
