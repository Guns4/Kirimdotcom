      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Buat label pengiriman yang profesional dengan logo toko Anda
            sendiri. Tinggalkan kesan pertama yang WOW! 🎨
          </p>
        </div>
        ...
        <div className="mt-12 bg-blue-50 rounded-xl border border-blue-200 p-6">
          ...
          <ol className="space-y-2 text-blue-800">
            ...
            <li className="flex items-start gap-2">
              ...
              <span>
                Klik "Download Label (PDF)" untuk mendapatkan file siap cetak
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="font-bold">5.</span>
              <span>
                Cetak di kertas stiker atau HVS biasa, lalu tempel di paket!
              </span>
            </li>
          </ol>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-700 mb-4">
                "Label dengan logo sendiri bikin toko saya terlihat lebih
                profesional. Customer jadi lebih percaya!"
              </p>
              <p className="text-sm font-semibold text-gray-900">
                - Budi, Toko Elektronik
              </p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md">
              <div className="flex items-center gap-1 mb-3">
              ...
              <p className="text-gray-700 mb-4">
                "Praktis banget! Dulu harus ke desainer, sekarang tinggal edit
                sendiri. Hemat waktu & uang."
              </p>
              <p className="text-sm font-semibold text-gray-900">
                - Siti, Online Shop
              </p>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-700 mb-4">
                "Repeat order naik 20% sejak pakai label branded. Customer ingat
                toko saya!"
              </p>
              <p className="text-sm font-semibold text-gray-900">
                - Ahmad, Reseller Fashion
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 text-center text-white">
          ...
          <ScrollToButton targetY={200}>Mulai Buat Label →</ScrollToButton>
        </div>
      </div>
    </main>
  );
