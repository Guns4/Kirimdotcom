...
export const metadata: Metadata = {
    ...
    description: 'Cek potensi retur paket COD berdasarkan kode pos dan reputasi nomor HP pembeli. Lindungi tokomu dari pembeli fiktif dan RTS.',
}
        ...
        <div className="min-h-screen bg-slate-950 py-20 px-4">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mt-16 text-center text-sm text-gray-600 max-w-2xl mx-auto">
                    <p>
                        DISCLAIMER: Data yang ditampilkan berdasarkan statistik historis dan laporan komunitas seller.
                        Keputusan pengiriman sepenuhnya berada di tangan Anda. Kami menjaga privasi data pembeli dengan metode hashing (SHA-256).
                    </p>
                </div>
            </div>
        </div>
