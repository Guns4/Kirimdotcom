...
export const metadata: Metadata = {
  ...
  description:
    'Pasang widget cek resi CekKirim di website atau blog Anda secara gratis.',
      ...
      <div className="container-custom">
        <div className="max-w-3xl mx-auto mb-12 text-center">
          ...
          <p className="text-xl text-gray-400">
            Mudahkan pengunjung website Anda melacak paket tanpa harus berpindah
            halaman. Gratis, ringan, dan mudah dipasang.
          </p>
        </div>
