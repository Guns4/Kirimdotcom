...
import {
  ...
  deleteApiKey,
  getKeys,
} from '@/app/actions/developerActions';
import {
  Copy,
  Plus,
  Trash2,
...
export default function DeveloperDashboard() {
  ...
  const handleDelete = async (id: string) => {
    if (
      !confirm('Permanently delete this API key? This action cannot be undone.')
    )
      return;
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-green-700 text-sm mb-4">
                Save this key immediately. You'll{' '}
                <span className="font-bold">never see it again</span> once you
                close this alert.
              </p>
      ...
      <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-6 mb-6 border border-indigo-100">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <input
            ...
            onKeyDown={(e) =>
              e.key === 'Enter' && !loading && !newKey && handleCreate()
            }
            ...
            keys.map((k) => (
              <div
                ...
                className={`p-5 flex items-center justify-between hover:bg-gray-50 transition ${
                  !k.is_active ? 'opacity-60 bg-gray-50' : ''
                }`}
              >
