            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">
                        Kode Affiliate Anda: <span className="font-mono font-bold text-purple-600">{affiliate.affiliate_code}</span>
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
                        ...
                        <p className="text-2xl font-bold text-gray-900">{formatRupiah(stats.totalEarnings)}</p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500">
                        ...
                        <h3 className="text-sm font-medium text-gray-600 mb-1">Saldo Tersedia</h3>
                        <p className="text-2xl font-bold text-gray-900">{formatRupiah(stats.availableBalance)}</p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500">
                        ...
                        <h3 className="text-sm font-medium text-gray-600 mb-1">Total Referral</h3>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-yellow-500">
                        ...
                        <h3 className="text-sm font-medium text-gray-600 mb-1">Komisi Pending</h3>
                        <p className="text-2xl font-bold text-gray-900">{formatRupiah(stats.pendingEarnings)}</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md p-6 mb-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                        ...
                        >
                            <p className="font-semibold text-purple-900">📢 Promosikan Produk</p>
                            <p className="text-sm text-purple-700 mt-1">Dapatkan link affiliate</p>
                        </a>
                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                    <h2 className="text-xl font-bold text-gray-900 mb-4">Komisi Terbaru</h2>

                    {stats.recentEarnings.length === 0 ? (
                        <div className="text-center py-12">
                            <p className="text-gray-500 mb-4">Belum ada komisi yang dihasilkan</p>
                            <a
                                href="/shop"
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="border-b border-gray-200">
                                        ...
                                        <th className="text-left py-3 px-4 text-sm font-semibold text-gray-700">Nilai Transaksi</th>
                                        <th className="text-left py-3 px-4 text-sm font-semibold text-gray-700">Komisi</th>
                                    ...
                                    {stats.recentEarnings.map((earning: any) => (
                                        <tr key={earning.id} className="border-b border-gray-100 hover:bg-gray-50">
                                            <td className="py-3 px-4 text-sm text-gray-700">
                                                {new Date(earning.earned_at).toLocaleDateString('id-ID')}
                                            </td>
                                            ...
                                            <td className="py-3 px-4">
                                                <span
                                                    className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${earning.status === 'pending'
