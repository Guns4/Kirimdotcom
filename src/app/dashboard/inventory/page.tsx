          ...
          {products.map((product) => (
            ...
            >
              <div className="flex items-center gap-4 flex-1">
                <div
                  className={`p-3 rounded-lg ${product.stock <= product.min_stock_alert ? 'bg-orange-100 text-orange-600' : 'bg-gray-100 text-gray-600'}`}
                >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 font-mono">
                    {product.sku} • Rp {product.price.toLocaleString()}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center bg-gray-50 rounded-lg p-1 border">
                  ...
                  <span
                    className={`w-12 text-center font-bold ${product.stock <= product.min_stock_alert ? 'text-red-600' : ''}`}
                  >
                    {product.stock}
                  </span>
                  <Button
