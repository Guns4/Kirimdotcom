import { getOrCreateWallet, getWalletTransactions, formatIDR, depositToWallet, withdrawFromWallet } from '@/app/actions/walletActions';
import { createClient } from '@/utils/supabase/server';
import { redirect } from 'next/navigation';
import { Wallet, TrendingUp, TrendingDown, ArrowRightLeft, Plus, Minus } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto">
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Cairkan ke rekening bank</p>
                            </div>
                        </div>
                        ...
                        <form action={handleWithdraw} className="space-y-4">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-1">
                                    Min: Rp 50,000 | Max: {formatIDR(wallet?.available_balance || 0)}
                                </p>
                            </div>
                            <button
                                type="submit"
                                ...
                                return (
                                    <div key={tx.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                                        <div className="flex items-center gap-4">
                                            <div className={`w-12 h-12 rounded-full flex items-center justify-center ${type === 'credit' ? 'bg-green-100' :
                                                    type === 'debit' ? 'bg-red-100' :
                                                        'bg-blue-100'
                                                }`}>
                                                {type === 'credit' ? (
                                        ...
                                        <div className="text-right">
                                            ...
                                            <span className={`inline-block px-2 py-1 rounded text-xs font-semibold ${tx.status === 'completed'
                ...
                <div className="mt-8 bg-blue-50 border border-blue-200 rounded-xl p-6">
                    ...
                    <ul className="text-sm text-blue-800 space-y-2">
                        <li>• Saldo wallet dapat digunakan untuk semua transaksi di CekKirim</li>
                        <li>• Top up minimum: Rp 10,000</li>
                        <li>• Penarikan minimum: Rp 50,000</li>
                        <li>• Semua transaksi menggunakan teknologi ACID-compliant untuk keamanan maksimal</li>
