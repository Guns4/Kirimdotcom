import {
  ...
  getRiskCategoryDetails,
  requestScoreRecalculation,
} from '@/app/actions/creditScoreActions';
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Terakhir diperbarui: {formatDate(currentScore.calculated_at)}
            </p>
          </div>
        ...
        <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl shadow-xl p-8 mb-8 text-white">
          <div className="flex items-center justify-between">
              ...
              <div className="flex items-baseline gap-4">
                ...
                <div>
                  ...
                  {currentScore.score_change !== 0 && (
                    <p
                      className={`text-sm ${currentScore.score_change > 0 ? 'text-green-200' : 'text-red-200'}`}
                    >
                      {currentScore.score_change > 0 ? '+' : ''}
                      {currentScore.score_change} dari sebelumnya
                    </p>
                  )}
                </div>
              </div>
            ...
            <div className="text-right">
              <div
                className={`inline-block px-6 py-3 rounded-full bg-${riskDetails.color}-100 mb-4`}
              >
                <p
                  className={`text-${riskDetails.color}-900 font-bold text-lg`}
                >
                  {riskDetails.label}
                </p>
              </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-3">
                    <div
                      ...
                      style={{
                        width: `${(scoreFactors.order_success.score / 340) * 100}%`,
                      }}
                    ></div>
                  </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-3">
                    <div
                      ...
                      style={{
                        width: `${(scoreFactors.dispute_rate.score / 255) * 100}%`,
                      }}
                    ></div>
                  </div>
                  <p className="text-xs text-gray-500 mt-1">
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-3">
                    <div
                      ...
                      style={{
                        width: `${(scoreFactors.payment_history.score / 170) * 100}%`,
                      }}
                    ></div>
                  </div>
                  <p className="text-xs text-gray-500 mt-1">
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-3">
                    <div
                      ...
                      style={{
                        width: `${(scoreFactors.account_age.score / 85) * 100}%`,
                      }}
                    ></div>
                  </div>
                  <p className="text-xs text-gray-500 mt-1">
                    ...
                    >
                      ...
                      <td className="py-3 px-4">
                        {record.score_change !== 0 && (
                          <span
                            className={`text-sm font-semibold ${record.score_change > 0 ? 'text-green-600' : 'text-red-600'}`}
                          >
                            {record.score_change > 0 ? '+' : ''}
                            {record.score_change}
                          </span>
                      ...
                      <td className="py-3 px-4">
                        <span
                          className={`inline-block px-3 py-1 rounded-full text-xs font-semibold bg-${getRiskCategoryDetails(record.risk_category).color}-100 text-${getRiskCategoryDetails(record.risk_category).color}-800`}
                        >
