import {
  ...
  applyForPayLater,
  makePayLaterRepayment,
} from '@/app/actions/payLaterActions';
...
export default async function PayLaterDashboardPage() {
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg">
                Cashflow seller macet karena COD lama cair? Kami bayari dulu
                ongkirnya!
              </p>
            </div>
  ...
  const utilizationPercent =
    ((account.credit_limit - account.available_credit) / account.credit_limit) *
    100;
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700">
                  Aplikasi PayLater Anda sedang diproses. Kami akan memberitahu
                  via email.
                </p>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
            ...
            <p className="text-2xl font-bold text-gray-900">
              {formatRupiah(account.available_credit)}
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500">
            ...
            <p className="text-2xl font-bold text-gray-900">
              {formatRupiah(account.used_credit)}
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-red-500">
            ...
            <p className="text-2xl font-bold text-gray-900">
              {formatRupiah(account.current_outstanding)}
            </p>
          </div>
        </div>
