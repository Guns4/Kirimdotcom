...
export default function PricingPage() {
  ...
  const ctaVariant = useExperiment('pricing_cta_text_v1', [
    'original',
    'action_focused',
  ]);
  const ctaText =
    ctaVariant === 'action_focused' ? 'Mulai Sekarang' : 'Upgrade via WA';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          >
            ...
            <a
              href={
                lifetimePlan ? generateWhatsAppUpgradeUrl(lifetimePlan) : '#'
              }
              target="_blank"
              rel="noopener noreferrer"
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/10">
                ...
                <th className="text-center py-4 px-4 text-indigo-400 font-medium">
                  Pro
                </th>
              </tr>
            </thead>
