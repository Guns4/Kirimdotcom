        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-b from-error-50 to-white">
          ...
          <div className="relative mb-8">
            <svg className="w-48 h-48" viewBox="0 0 300 300" fill="none">
              ...
              {/* Error on screen */}
              <path
                d="M130 110L170 140M170 110L130 140"
                stroke="#EF4444"
                strokeWidth="4"
                strokeLinecap="round"
              />
              ...
              <path
                d="M130 200C130 210 170 210 170 200"
                stroke="#9CA3AF"
                strokeWidth="4"
                fill="none"
              />
          ...
          <p className="text-surface-500 text-center max-w-md mb-6">
            Sistem kami sedang mengalami gangguan. Tim teknis sudah diberitahu
            dan sedang bekerja memperbaikinya.
          </p>
