    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-b from-warning-50 to-white">
            ...
            <div className="relative mb-8">
                <svg className="w-48 h-48" viewBox="0 0 300 300" fill="none">
                    ...
                    <g transform="translate(200, 80)">
                        ...
                        <text x="30" y="38" fontSize="24" textAnchor="middle" fill="#EF4444">✋</text>
                    </g>

                    {/* Clock */}
                    <g transform="translate(40, 100)">
                        <circle cx="25" cy="25" r="25" fill="white" stroke="#F59E0B" strokeWidth="3" />
                        <line x1="25" y1="25" x2="25" y2="12" stroke="#F59E0B" strokeWidth="3" strokeLinecap="round">
                            <animateTransform
            ...
            <p className="text-surface-500 text-center max-w-md mb-6">
                ...
                Sistem kami perlu istirahat sebentar. Silakan tunggu beberapa saat.
            </p>

            {/* Timer */}
            <div className="bg-surface-100 rounded-2xl p-6 mb-8 text-center">
                <p className="text-sm text-surface-500 mb-2">Coba lagi dalam</p>
                <div className="text-4xl font-bold text-primary-600 font-mono" id="countdown">
                    00:60
                </div>
            ...
            <div className="bg-primary-50 rounded-xl p-4 max-w-md text-center mb-8">
                <p className="text-sm text-primary-700">
                    💡 <strong>Tips:</strong> Gunakan fitur Bulk Tracking untuk cek banyak resi sekaligus tanpa limit!
                </p>
            </div>
