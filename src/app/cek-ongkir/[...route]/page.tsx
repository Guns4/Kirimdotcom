...
export default async function OngkirRoutePage({ params }: PageProps) {
  ...
  const relatedRoutes = popularRoutes
    .filter(
      (r) =>
        r.originSlug === parsed.origin ||
        r.destinationSlug === parsed.destination
    )
    .filter(
      (r) =>
        !(
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <nav className="mb-6 text-sm">
          <ol className="flex items-center gap-2 text-gray-400">
            ...
            <li>/</li>
            <li>
              <Link href="/#ongkir" className="hover:text-white">
                Cek Ongkir
              </Link>
            </li>
            <li>/</li>
            <li className="text-white">
              {originName} ke {destinationName}
            </li>
          </ol>
        </nav>
        ...
        <header className="mb-12">
          ...
          <p className="text-gray-400 text-lg mb-6">
            Update {currentYear} - Bandingkan harga pengiriman dari semua
            ekspedisi Indonesia
          </p>
        ...
        <article className="glass-card p-8 mb-12 prose prose-invert max-w-none">
          <h2>
            Tentang Pengiriman {originName} ke {destinationName}
          </h2>
          <p>
            Mencari ongkos kirim termurah dari <strong>{originName}</strong> ke{' '}
            <strong>{destinationName}</strong>? CekKirim membantu Anda
            membandingkan tarif pengiriman dari berbagai ekspedisi seperti JNE,
            J&T Express, SiCepat, AnterAja, Ninja Xpress, dan lainnya.
          </p>
          <p>
            Harga ongkir di atas dihitung berdasarkan berat 1 kg. Untuk paket
            yang lebih berat, Anda dapat menggunakan{' '}
          ...
          <ul>
            ...
            <li>
              Kemas paket dengan efisien untuk mengurangi berat volumetrik
            </li>
          </ul>
        </article>
        ...
        <section className="glass-card p-8 text-center bg-gradient-to-r from-indigo-600/20 to-purple-600/20">
          ...
          <p className="text-gray-400 mb-6">
            Gunakan kalkulator ongkir kami untuk cek tarif pengiriman ke seluruh
            Indonesia
          </p>
          <Link
            href="/"
