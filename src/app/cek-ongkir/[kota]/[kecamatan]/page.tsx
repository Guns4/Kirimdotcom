...
export async function generateMetadata({ params }: PageProps) {
  ...
  const couriers =
    kecamatan.available_couriers?.join(', ') || 'JNE, J&T, SiCepat';
...
export default async function KecamatanPage({ params }: PageProps) {
  ...
  const couriers =
    kecamatan.available_couriers?.join(', ') || 'JNE, J&T, SiCepat, AnterAja';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <nav className="text-sm mb-6">
          <ol className="flex items-center gap-2 text-gray-600">
            ...
            <li>
              <Link href="/cek-ongkir" className="hover:text-blue-600">
                Cek Ongkir
              </Link>
            </li>
            <ChevronRight className="w-4 h-4" />
            <li>
              <Link
                href={`/cek-ongkir/${kota}`}
                className="hover:text-blue-600"
              >
                {kecamatan.cities.city_name}
              </Link>
            </li>
            <ChevronRight className="w-4 h-4" />
        ...
        <article className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <header className="mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              Cek Ongkir ke {kecamatan.kecamatan_name},{' '}
              {kecamatan.cities.city_name}
            </h1>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-6 mb-8 text-white">
            ...
            <p className="mb-4 opacity-90">
              Masukkan detail pengiriman Anda dan dapatkan perbandingan harga
              dari semua ekspedisi
            </p>
            <Link
              href="/"
          ...
          <section className="prose max-w-none mb-8">
            <p className="text-lg text-gray-700 leading-relaxed">
              Mau kirim paket ke{' '}
              <strong>
                {kecamatan.kecamatan_name}, {kecamatan.cities.city_name}
              </strong>
              ? Bandingkan tarif ongkir dari berbagai ekspedisi di sini! Kami
              menyediakan perbandingan harga dari {couriers} dan ekspedisi
              lainnya.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              <p className="text-gray-700">
                Rata-rata waktu pengiriman ke{' '}
                <strong>
                  {kecamatan.kecamatan_name}, {kecamatan.cities.city_name}
                </strong>{' '}
                adalah{' '}
                <span className="font-bold text-blue-600">
                  {kecamatan.avg_delivery_days} hari kerja
                </span>
                . Namun, waktu sebenarnya bisa bervariasi tergantung layanan
                yang dipilih (reguler/express) dan lokasi asal pengiriman.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <ol className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Bandingkan harga</strong> dari berbagai ekspedisi
                  sebelum checkout
                </span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Pilih layanan reguler</strong> jika tidak terburu-buru
                  untuk hemat biaya
                </span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Manfaatkan promo</strong> gratis ongkir dari
                  marketplace atau toko
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="font-bold text-blue-600">4.</span>
                <span>
                  <strong>Kirim dalam jumlah banyak</strong> untuk mendapat
              ...
              {popularCities.map((city: any) => (
                ...
                >
                  ...
                  <span className="text-sm text-gray-600 ml-2">
                    ({city.total_kecamatan} kecamatan)
                  </span>
                </Link>
              ))}
            </div>
