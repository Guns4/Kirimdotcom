            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="glass-card p-8 text-center">
                    ...
                    <div className="bg-white/5 rounded-xl p-6 text-left">
                        <h2 className="text-sm font-semibold text-gray-400 mb-4 uppercase tracking-wider">Status Pengiriman</h2>
                        {/* 
                        ...
                        */}
                        <div className="flex gap-4">
                            ...
                            <div className="pb-8">
                                ...
                                <p className="text-sm text-gray-400">Menghubungi server ekspedisi</p>
                            </div>
                        </div>
                    </div>
