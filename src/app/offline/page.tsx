    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center p-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-gray-600 mb-8">
          Sepertinya koneksi internet Anda terputus. Silakan cek koneksi dan
          coba lagi.
        </p>
        ...
        <div className="mt-8 p-4 bg-blue-50 rounded-lg">
          <p className="text-sm text-blue-900">
            💡 <strong>Tips:</strong> Aplikasi CekKirim sudah ter-install.
            Beberapa halaman masih bisa dibuka secara offline.
          </p>
        </div>
      </div>
    </main>
