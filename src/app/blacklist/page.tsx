      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Analisis risiko calon pembeli menggunakan{' '}
            <span className="text-indigo-600 font-bold">TrustScore AI</span>.
          </p>
        </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
                    <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2">
                      <Shield className="w-5 h-5 text-indigo-600" /> Analysis
                      Result
                    </h3>
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-200 text-xs text-gray-400">
                      * Skor dihitung berdasarkan recency & validitas bukti
                      laporan.
                    </div>
                  </div>
                </div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center mb-3 text-2xl">
              ✓
            </div>
            <h3 className="font-bold text-gray-900">AMAN (80-100)</h3>
            <p className="text-sm text-gray-500 mt-1">
              Minim laporan atau belum ada data. Transaksi relatif aman.
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="w-10 h-10 bg-yellow-100 rounded-lg flex items-center justify-center mb-3 text-2xl">
              ⚡
            </div>
            <h3 className="font-bold text-gray-900">WASPADA (40-79)</h3>
            <p className="text-sm text-gray-500 mt-1">
              Ada riwayat masalah minor. Gunakan proteksi tambahan.
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="w-10 h-10 bg-red-100 rounded-lg flex items-center justify-center mb-3 text-2xl">
              ⚠️
            </div>
            <h3 className="font-bold text-gray-900">BAHAYA (0-39)</h3>
            <p className="text-sm text-gray-500 mt-1">
              Sering bermasalah. Hindari transaksi COD.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-center text-white shadow-xl shadow-blue-900/20">
          ...
          <p className="mb-6 opacity-90">
            Bantu seller lain dengan melaporkan customer bermasalah ke database
            nasional.
          </p>
          <a
