...
export const metadata: Metadata = {
  ...
  description:
    'Platform logistik terlengkap Indonesia. Lacak paket semua kurir, cek ongkir murah, booking resi, dan kurir lokal.',
};
    ...
    <Card variant="elevated" padding="lg" className="h-full">
      <div className="space-y-6">
        ...
        <div className="pt-4 border-t border-surface-100">
          <p className="text-body-xs text-surface-500 mb-3">
            Mendukung semua kurir:
          </p>
          <div className="flex flex-wrap items-center gap-4 text-surface-400 text-sm font-medium">
            ...
            <span className="px-3 py-1.5 bg-surface-100 rounded-lg">
              SiCepat
            </span>
            <span className="px-3 py-1.5 bg-surface-100 rounded-lg">
              AnterAja
    ...
    <main className="min-h-screen bg-surface-50">
      ...
      <section className="section-tight">
        <div className="container-main">
          <Card
            variant="gradient"
            className="bg-gradient-primary text-white text-center p-8 md:p-12"
          >
