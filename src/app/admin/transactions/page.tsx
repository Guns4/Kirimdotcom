...
import {
  getAllPayments,
  getAllUsers,
} from '@/app/actions/adminTransactionActions';
...
export default async function AdminTransactionsPage() {
  ...
  const premiumUsers = users.filter(
    (u: any) => u.user_subscriptions?.is_premium
  ).length;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Approve payments and manage user access
          </p>
        </div>
          ...
          <div className="p-6 border-b border-gray-200 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Link
                ...
                className="px-3 py-1 bg-gray-100 text-gray-800 text-sm font-semibold rounded hover:bg-gray-200 transition"
              >
                All
              </Link>
            </div>
