            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="text-center space-y-4">
                    ...
                    <p className="text-gray-400 max-w-2xl mx-auto">
                        Kumpulan template chat WhatsApp yang paling sering digunakan seller online.
                        Tinggal copy-paste, edit sedikit, kirim!
                    </p>
                </div>
...
function TemplateCard({ template }: { template: { title: string, content: string } }) {
