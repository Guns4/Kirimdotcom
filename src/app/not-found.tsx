  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-b from-surface-50 to-white">
      ...
      <div className="relative mb-8">
        <svg className="w-64 h-64" viewBox="0 0 400 400" fill="none">
          ...
          <g transform="translate(120, 100)">
            {/* Box body */}
            <path
              d="M0 60L80 20L160 60L80 100L0 60Z"
              fill="#C7D2FE"
              stroke="#6366F1"
              strokeWidth="3"
            />
            <path
              d="M0 60V140L80 180V100L0 60Z"
              fill="#E0E7FF"
              stroke="#6366F1"
              strokeWidth="3"
            />
            <path
              d="M160 60V140L80 180V100L160 60Z"
              fill="#A5B4FC"
              stroke="#6366F1"
              strokeWidth="3"
            />
            ...
            {/* Box flaps */}
            <path
              d="M0 60L30 40L80 70L50 90L0 60Z"
              fill="#EEF2FF"
              stroke="#6366F1"
              strokeWidth="2"
            />
            <path
              d="M160 60L130 40L80 70L110 90L160 60Z"
              fill="#EEF2FF"
              stroke="#6366F1"
              strokeWidth="2"
            />
            ...
            <text x="65" y="130" fontSize="40" fill="#6366F1" fontWeight="bold">
              ?
            </text>
          </g>
          ...
          <text x="80" y="120" fontSize="24" fill="#A5B4FC">
            ?
          </text>
          <text x="300" y="140" fontSize="20" fill="#A5B4FC">
            ?
          </text>
          <text x="320" y="260" fontSize="28" fill="#C7D2FE">
            ?
          </text>
      ...
      <p className="text-surface-500 text-center max-w-md mb-8">
        ...
        dihapus, atau alamatnya salah ketik.
      </p>
