...
export const metadata: Metadata = {
  ...
  description:
    'Tools gratis untuk membuat dan cetak label resi pengiriman online shop. Format Thermal A6 (100x150mm), support barcode dan simpan data pengirim otomatis.',
  keywords: [
    'cetak label pengiriman',
    'resi thermal',
    'label a6',
    'cetak resi',
    'generator label resi',
  ],
};
