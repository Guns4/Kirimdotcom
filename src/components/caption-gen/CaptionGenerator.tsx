...
export default function CaptionGenerator({ templates }: CaptionGeneratorProps) {
    ...
    const filteredTemplates = templates.filter(template => {
        ...
        const matchesType = selectedType === 'all' || template.sales_type === selectedType;
        const matchesSearch = template.template_text.toLowerCase().includes(searchQuery.toLowerCase()) ||
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="mt-4 text-sm text-gray-600">
                    Menampilkan <span className="font-bold">{filteredTemplates.length}</span> caption
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                {filteredTemplates.length === 0 ? (
                    <div className="col-span-2 text-center py-12">
                        <p className="text-gray-500 mb-4">Tidak ada caption yang sesuai filter</p>
                        <button
                            onClick={() => {
                        ...
                        >
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <span className="inline-block px-2 py-1 bg-blue-100 text-blue-800 text-xs font-semibold rounded">
                                            {types.find(t => t.value === template.sales_type)?.label}
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className={`flex-1 ${copiedId === template.id
                                            ? 'bg-green-600'
