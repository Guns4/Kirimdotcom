...
export function WhatsAppShareButton({ trackingData }: WhatsAppShareButtonProps) {
    ...
    const handleOpen = () => {
        ...
        const latestStatus = trackingData.history?.[0]?.desc || trackingData.currentStatus
        const trackingLink = typeof window !== 'undefined' ? window.location.href : 'https://cekkirim.com'
