...
export default function DangerousGoodsChecker() {
    ...
    return (
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm max-w-xl mx-auto">
            ...
            {/* Result Card */}
            {result && (
                <div className={`mt-6 p-4 rounded-lg border ${result.status === 'safe' ? 'bg-green-50 border-green-200' :
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <p className={`font-bold text-lg ${result.status === 'safe' ? 'text-green-800' :
