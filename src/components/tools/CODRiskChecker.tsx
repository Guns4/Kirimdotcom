          ...
          {activeTab === 'postal' ? (
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">
                  Ketahui tingkat retur COD berdasarkan statistik kode pos.
                </p>
              </div>
              ...
              {postalResult && (
                ...
                >
                  {postalResult.error ? (
                    ...
                    <>
                      <div className="text-lg font-medium mb-1 opacity-80">
                        TINGKAT RISIKO
                      </div>
                      <div className="text-4xl font-bold mb-4">
                        {postalResult.riskLevel?.toUpperCase()}
                      </div>

                      <div className="flex items-center justify-center gap-2 text-sm opacity-70 border-t border-white/10 pt-4 mt-4">
                        <MapPin className="w-4 h-4" />
                        <span>
                          {postalResult.city}, {postalResult.province}
                        </span>
                      </div>
                    </>
                  )}
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">
                  Cek apakah nomor HP pernah dilaporkan melakukan penolakan
                  paket.
                </p>
                  ...
                  {phoneResult.isClean ? (
                    <div className="space-y-3">
                      ...
                      <p className="text-gray-400 text-sm">
                        Nomor ini belum pernah dilaporkan menolak paket di
                        database kami.
                      </p>
                    </div>
                  ) : (
                    <div className="space-y-3">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-red-400">
                          {phoneResult.reportCount}x Dilaporkan
                        </h3>
                        <p className="text-xs text-red-300/70 mt-1">
                          Terakhir:{' '}
                          {new Date(
                            phoneResult.lastReportedAt
                          ).toLocaleDateString()}
                        </p>
                      </div>
