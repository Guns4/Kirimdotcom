            ...
            {step === 1 && (
              ...
              >
                <div className="p-4 bg-indigo-500/10 rounded-xl border border-indigo-500/20 text-sm text-indigo-200">
                  Untuk mencegah penyalahgunaan, mohon verifikasi bahwa nomor
            ...
            {step === 3 && (
              ...
              >
                ...
                <p className="text-gray-400 text-sm mb-6">
                  Tim kami akan meninjau laporan Anda. Jika disetujui, label
                  risiko akan dihapus dalam 1x24 jam.
                </p>
                <button
                  onClick={onClose}
