      ...
      <div className="print:hidden space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-500 max-w-lg mx-auto">
            Buat stiker QR Code untuk paket Anda. Saat discan pembeli, langsung
            membuka halaman tracking CekKirim.com.
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Masukkan detail pengiriman untuk membuat QR
            </CardDescription>
          </CardHeader>
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 p-6 bg-gray-50 rounded-xl border border-gray-100 mt-6">
                ...
                <div className="flex-1 space-y-4 text-center md:text-left">
                  ...
                  <p className="text-xs text-muted-foreground bg-blue-50 text-blue-600 px-3 py-1 rounded-full inline-block">
                    💡 Tips: Tombol "Cetak" akan membuat 12 stiker dalam 1
                    halaman A4
                  </p>
                </div>
              </div>
        ...
        <div className="hidden print:block print:w-full">
          <div className="grid grid-cols-3 gap-4 w-full h-full p-4">
            {Array.from({ length: 12 }).map((_, i) => (
              <div
                key={i}
                className="border-2 border-dashed border-gray-300 rounded-xl p-4 flex flex-col items-center justify-center gap-2 aspect-[3/2] break-inside-avoid"
              >
                <p className="text-xs font-bold text-gray-500 uppercase tracking-wider">
                  Scan untuk Lacak Paket
                </p>
                <Canvas
                  text={generatedUrl}
                  options={{
