      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="glass-card p-6">
            ...
            <p className="text-xs text-gray-500 mt-2">
              Salin kode di atas dan tempelkan di halaman website atau blog Anda
              (WordPress, Blogger, dll).
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-3 text-sm text-gray-400 bg-yellow-500/10 p-4 rounded-xl border border-yellow-500/20">
            ...
            <p>
              Widget ini responsif dan background transparan, sehingga akan
              menyatu sempurna dengan desain website Anda.
            </p>
          </div>
        </div>
      </div>
