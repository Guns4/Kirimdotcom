    ...
    <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-6 border border-purple-200">
      ...
      <div className="mt-4 bg-purple-100 rounded-lg p-3">
        <p className="text-xs text-purple-800">
          💡 <span className="font-semibold">Tips:</span> Bagikan link ini ke
          teman, keluarga, atau follower media sosial Anda. Setiap pembelian
          melalui link ini akan menghasilkan komisi untuk Anda!
        </p>
      </div>
    </div>
  );
