...
import { getCourierAffiliateConfig, type CourierAffiliateConfig } from '@/config/affiliates'
...
export function ActionButton({ courierCode, variant = 'default', className = '' }: ActionButtonProps) {
