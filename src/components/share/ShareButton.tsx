...
import { Download, Share2, Copy, Check, Image as ImageIcon, Loader2 } from 'lucide-react'
                            ...
                            <div className="p-2">
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-white">Save as PNG</p>
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-white">Save as JPG</p>
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-xs text-gray-400 truncate">{trackingUrl.replace('https://', '')}</p>
                                    </div>
                                </button>
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-white">Share to WhatsApp</p>
