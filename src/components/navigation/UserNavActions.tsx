...
import { Bell, ChevronDown, LogOut, Settings, User, Wallet, CreditCard, HelpCircle } from 'lucide-react';
...
export function UserNavActions({
    ...
    // Authenticated state
    return <AuthenticatedActions user={user} notificationCount={notificationCount} onLogout={onLogout} />;
}
...
function AuthenticatedActions({ user, notificationCount, onLogout }: AuthenticatedActionsProps) {
            ...
            <div className="relative" ref={dropdownRef}>
                ...
                >
                    ...
                    <div className="px-4 py-3 border-b border-surface-100">
                        <p className="font-semibold text-surface-800 truncate">{user.name}</p>
                    ...
                    <div className="sm:hidden px-2 py-2 border-b border-surface-100">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-xs text-surface-500">Rp {(user.balance || 0).toLocaleString('id-ID')}</p>
                            </div>
                        </Link>
                    </div>
                    ...
                    <div className="px-2 py-2">
                        <DropdownItem href="/dashboard" icon={User} label="Dashboard" onClick={() => setIsDropdownOpen(false)} />
                        <DropdownItem href="/dashboard/wallet" icon={CreditCard} label="Wallet & Topup" onClick={() => setIsDropdownOpen(false)} />
                        <DropdownItem href="/dashboard/settings" icon={Settings} label="Pengaturan" onClick={() => setIsDropdownOpen(false)} />
                        <DropdownItem href="/help" icon={HelpCircle} label="Bantuan" onClick={() => setIsDropdownOpen(false)} />
                    </div>
