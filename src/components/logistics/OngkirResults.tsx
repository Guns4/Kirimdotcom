...
export function OngkirResults({
  ...
  const footprint = calculateCarbonFootprint(originId, destinationId, {
    value: weight,
    isGrams: true,
  });
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="mt-2 text-[10px] text-gray-400 italic">
                *Estimasi emisi transportasi darat. Gabungkan pesanan untuk
