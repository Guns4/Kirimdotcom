...
export function FailSafeFallback({
  courier,
  officialUrl,
}: FailSafeFallbackProps) {
  return (
    <motion.div
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
              Sistem kami mendeteksi ganguan dari server pusat {courier}. Namun
              jangan khawatir, Anda tetap bisa melacak paket melalui link
              alternatif resmi di bawah ini.
            </p>
