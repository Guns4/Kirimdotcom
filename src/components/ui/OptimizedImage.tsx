...
export function OptimizedImage({
    ...
    return (
        <div className={cn('relative overflow-hidden', aspectRatioClass[aspectRatio], className)}>
            {/* Skeleton loading */}
...
export function ProductImage({ src, alt, className, enableZoom = true }: ProductImageProps) {
