...
export function CommandPalette({ customCommands = [] }: CommandPaletteProps) {
  ...
  const defaultCommands: Command[] = [
    ...
    },
    {
      ...
      title: 'Tambah Produk',
      category: 'action',
      action: () => router.push('/dashboard/inventory/new'),
    ...
    },
    {
      ...
      title: 'Top Up Wallet',
      category: 'action',
      action: () => router.push('/dashboard/wallet?action=topup'),
      keywords: ['isi saldo'],
    },
    {
      id: 'track',
    ...
    },
    {
      ...
      title: 'Bulk Tracking',
      category: 'action',
      action: () => router.push('/bulk-tracking'),
      keywords: ['banyak resi'],
    },
  ...
  const filteredCommands = query.trim()
    ? allCommands.filter((cmd) => {
        const searchStr =
          `${cmd.title} ${cmd.subtitle || ''} ${cmd.keywords?.join(' ') || ''}`.toLowerCase();
