    ...
    return (
        <div
            className={cn(
                ...
                variant === 'gradient' && 'bg-gradient-to-br from-primary-50 via-white to-accent-50',
...
export const PAGE_HEADERS = {
    blacklist: {
        title: 'Cek Blacklist',
        description: 'Cegah kerugian COD dengan database gotong royong dari ribuan seller.',
        breadcrumbs: [{ label: 'Cek Blacklist' }],
    },
    ppob: {
        title: 'PPOB & Pulsa',
        description: 'Jual pulsa, paket data, token PLN, dan PPOB lainnya dengan harga kompetitif.',
        breadcrumbs: [{ label: 'PPOB' }],
        badge: 'Promo',
    },
    forum: {
        title: 'Forum Seller',
        description: 'Diskusi, berbagi tips, dan networking dengan sesama seller se-Indonesia.',
        breadcrumbs: [{ label: 'Komunitas', href: '/community' }, { label: 'Forum' }],
    },
    tracking: {
        title: 'Cek Resi',
    ...
    ongkir: {
        title: 'Cek Ongkir',
        description: 'Bandingkan tarif pengiriman dari berbagai kurir secara real-time.',
        breadcrumbs: [{ label: 'Cek Ongkir' }],
    },
    marketplace: {
        title: 'Supplier Directory',
        description: 'Temukan supplier terpercaya untuk bisnis dropship dan reseller Anda.',
        breadcrumbs: [{ label: 'Marketplace' }],
    },
    rewards: {
        title: 'Rewards & Leaderboard',
        description: 'Kumpulkan poin dari setiap transaksi dan tukar dengan hadiah menarik.',
        breadcrumbs: [{ label: 'Rewards' }],
    },
    help: {
        title: 'Pusat Bantuan',
        description: 'Temukan jawaban untuk pertanyaan Anda atau hubungi tim support kami.',
        breadcrumbs: [{ label: 'Bantuan' }],
    },
    cetakLabel: {
        title: 'Cetak Label',
        description: 'Cetak label pengiriman untuk thermal printer dengan format standar ekspedisi.',
