        ...
        <div className="bg-indigo-600 text-white px-4 py-3 relative shadow-md">
            <div className="container mx-auto flex items-center justify-between">
                <p className="font-medium text-sm text-center w-full">
                    🎉 <span className="font-bold">PROMO LEBARAN:</span> Diskon Ongkir 50% ke Seluruh Jawa!
                    <a href="#" className="underline ml-2 text-indigo-100 hover:text-white">Cek Sekarang</a>
                </p>
                <button
