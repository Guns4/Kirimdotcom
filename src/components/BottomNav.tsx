                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-3xl p-6 animate-slide-up safe-bottom">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <span className="font-semibold text-secondary-700">Scan QR</span>
                            </Link>
                            ...
                            >
                                ...
                                <span className="font-semibold text-success-700">Cek Ongkir</span>
                            </Link>
                            ...
                            >
                                ...
                                <span className="font-semibold text-warning-700">Booking Resi</span>
                            </Link>
                        </div>
