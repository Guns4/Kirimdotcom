                ...
                {tabs.map((tab) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Icon */}
                            <div className={`relative p-1.5 rounded-xl transition-colors ${active ? 'text-indigo-400' : 'text-gray-400 group-hover:text-gray-200'
                                }`}>
                                <Icon className="w-6 h-6" strokeWidth={active ? 2.5 : 2} />
                            </div>

                            {/* Label */}
                            <span className={`text-[10px] font-medium transition-colors ${active ? 'text-indigo-400' : 'text-gray-500'
                                }`}>
                                {tab.label}
                            </span>
                        </Link>
