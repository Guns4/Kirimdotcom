...
import { TrendingUp, Users, Database, DollarSign, AlertCircle } from 'lucide-react'
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="glass-card p-5 relative overflow-hidden group">
                    ...
                    <div>
                        <p className="text-gray-400 text-sm mb-1">Estimasi Revenue (Bulan Ini)</p>
                ...
                <div className="glass-card p-5 relative overflow-hidden group">
                    ...
                    <div>
                        <p className="text-gray-400 text-sm mb-1">User Retention (7 Hari)</p>
                        <h3 className="text-2xl font-bold text-white mb-2">
                ...
                {/* Cost/Supabase Card */}
                <div className={`glass-card p-5 relative overflow-hidden group border ${metrics.supabase.prediction === 'critical' ? 'border-red-500/30' :
                        metrics.supabase.prediction === 'warning' ? 'border-yellow-500/30' : 'border-white/10'
                    }`}>
                    <div className="absolute right-0 top-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                        <Database className={`w-24 h-24 ${metrics.supabase.prediction === 'critical' ? 'text-red-400' : 'text-purple-400'
                            }`} />
                    </div>
                    <div>
                        <p className="text-gray-400 text-sm mb-1">Supabase Load Estimator</p>
                        <h3 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
                            {metrics.supabase.reads.toLocaleString()} <span className="text-sm font-normal text-gray-500">Ops</span>
                        </h3>
