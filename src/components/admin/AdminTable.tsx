...
interface Column<T> {
    ...
    editRender?: (value: unknown, onChange: (value: unknown) => void) => React.ReactNode;
    width?: string;
}
...
interface AdminTableProps<T extends { id: string }> {
    ...
    onInlineEdit?: (id: string, key: string, value: unknown) => void | Promise<void>;
    loading?: boolean;
    emptyMessage?: string;
}
                ...
                <table className="w-full">
                    ...
                    <tbody className="divide-y divide-surface-100">
                        {loading ? (
                            ...
                            <tr>
                                <td colSpan={columns.length + 1} className="py-12 text-center text-surface-400">
                                    {emptyMessage}
                                </td>
                            </tr>
                        ) : (
                                    ...
                                    {columns.map((col) => {
                                        ...
                                        return (
                                            <td
                                                ...
                                                onDoubleClick={() => col.editable && startEdit(item.id, String(col.key), value)}
                                            >
                                                {isEditing ? (
                                                    <InlineEdit
                                                        value={editValue}
...
function InlineEdit({ value, onChange, onSave, onCancel, render }: InlineEditProps) {
