...
export default function ClarityAnalytics() {
  ...
  if (!CLARITY_PROJECT_ID) {
    if (process.env.NODE_ENV === 'development' && !consent) {
      console.warn(
        'Clarity Project ID missing. Define NEXT_PUBLIC_CLARITY_PROJECT_ID in .env'
      );
    }
  }
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4 leading-relaxed">
                  Kami merekam interaksi anonim untuk meningkatkan pengalaman
                  Anda. Data sensitif diblur otomatis.
                </p>
