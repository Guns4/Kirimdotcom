          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              {todos.map((todo) => (
                <div
                  key={todo.id}
                  className="group flex items-start gap-2 p-2 hover:bg-yellow-200/50 rounded-lg transition"
                >
                  <button
                  ...
                  <span
                    className={`text-sm flex-1 break-words ${todo.completed ? 'line-through text-yellow-900/50' : ''}`}
                  >
                    {todo.text}
                  </span>
                  <button
