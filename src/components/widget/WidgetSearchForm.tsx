...
export function WidgetSearchForm({ color = 'blue' }: WidgetSearchFormProps) {
    ...
    const getButtonColor = () => {
        switch (color) {
            case 'purple': return 'from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700'
            case 'green': return 'from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700'
            case 'red': return 'from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700'
            case 'orange': return 'from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600'
            case 'blue':
            default: return 'from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700'
        }
    }

    return (
        <form onSubmit={handleSubmit} className="w-full max-w-md bg-white/5 backdrop-blur-sm p-4 rounded-2xl border border-white/10 shadow-xl">
            ...
            <div className="mt-2 text-center">
                <a href="https://www.cekkirim.com" target="_blank" rel="noopener noreferrer" className="text-[10px] text-gray-400 hover:text-white transition-colors">
