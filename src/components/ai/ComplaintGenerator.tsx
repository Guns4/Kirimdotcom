...
export function ComplaintGenerator({ trackingData }: ComplaintGeneratorProps) {
    ...
    const generateComplaint = async () => {
        ...
        try {
            ...
            setError(err instanceof Error ? err.message : 'Gagal membuat teks komplain')
        } finally {
            setIsLoading(false)
        }
    }
                            ...
                            <div className="glass-card p-6 max-h-[90vh] overflow-y-auto">
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-bold text-white">Generator Teks Komplain</h3>
                                            <p className="text-sm text-gray-400">AI akan membuatkan teks profesional untuk Anda</p>
                                        </div>
                                    </div>
                                    <button
                                        onClick={() => setIsOpen(false)}
                                ...
                                <div className="bg-white/5 rounded-lg p-4 mb-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                        <div>
                                            ...
                                            <span className="text-white ml-2 font-mono">{trackingData.resiNumber}</span>
                                        </div>
                                        <div>
                                            <span className="text-gray-400">Kurir:</span>
                                            <span className="text-white ml-2">{trackingData.courier}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3">
                                    {isLoading && (
                                        <div className="flex flex-col items-center justify-center py-12">
                                            ...
                                            <p className="text-sm text-gray-400">Membuat teks komplain profesional...</p>
                                        </div>
                                    )}
                                    ...
                                    {complaintText && !isLoading && (
                                        ...
                                        >
                                            ...
                                            <p className="text-xs text-gray-500 mt-3 text-center">
                                                💡 Tip: Sesuaikan teks di atas sebelum mengirim ke customer service
                                            </p>
                                        </motion.div>
                                    )}
                                </div>
